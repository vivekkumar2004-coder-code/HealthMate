...
const SpecialityMenu = () => {
  return (
    <div id="speciality" className='flex flex-col items-center gap-4 py-16 text-gray-800' >
      ...
      <p className='sm:w-1/3 text-center text-sm '>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Necessitatibus enim molestias distinctio iure qui repellat?</p>
